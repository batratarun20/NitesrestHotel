...
function nd_booking_meta_box_save_cpt_4( $post_id )
{
    ...
    if ( isset( $nd_booking_meta_box_cpt_4_phone ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_phone' , $nd_booking_meta_box_cpt_4_phone ); }

    $nd_booking_meta_box_cpt_4_address = sanitize_text_field( $_POST['nd_booking_meta_box_cpt_4_address'] );
    if ( isset( $nd_booking_meta_box_cpt_4_address ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_address' , $nd_booking_meta_box_cpt_4_address ); }

    $nd_booking_meta_box_cpt_4_city = sanitize_text_field( $_POST['nd_booking_meta_box_cpt_4_city'] );
    if ( isset( $nd_booking_meta_box_cpt_4_city ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_city' , $nd_booking_meta_box_cpt_4_city ); }

    $nd_booking_meta_box_cpt_4_state = sanitize_text_field( $_POST['nd_booking_meta_box_cpt_4_state'] );
    if ( isset( $nd_booking_meta_box_cpt_4_state ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_state' , $nd_booking_meta_box_cpt_4_state ); }

    $nd_booking_meta_box_cpt_4_email = sanitize_text_field( $_POST['nd_booking_meta_box_cpt_4_email'] );
    if ( isset( $nd_booking_meta_box_cpt_4_email ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_email' , $nd_booking_meta_box_cpt_4_email ); }

    $nd_booking_meta_box_cpt_4_color = sanitize_hex_color( $_POST['nd_booking_meta_box_cpt_4_color'] );
    if ( isset( $nd_booking_meta_box_cpt_4_color ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_color' , $nd_booking_meta_box_cpt_4_color ); }

    $nd_booking_meta_box_cpt_4_stars = sanitize_option( 'nd_booking_meta_box_cpt_4_stars', $_POST['nd_booking_meta_box_cpt_4_stars'] );
    if ( isset( $nd_booking_meta_box_cpt_4_stars ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_stars' , $nd_booking_meta_box_cpt_4_stars ); }

    //page settings : sanitize and validate
    $nd_booking_meta_box_image_cpt_4 = esc_url_raw( $_POST['nd_booking_meta_box_image_cpt_4'] );
    if ( isset( $nd_booking_meta_box_image_cpt_4 ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_image_cpt_4' , $nd_booking_meta_box_image_cpt_4 ); }
    ...
    if ( isset( $nd_booking_meta_box_image_cpt_4_position ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_image_cpt_4_position' , $nd_booking_meta_box_image_cpt_4_position ); }
    ...
    if ( isset( $nd_booking_meta_box_page_layout_cpt_4 ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_page_layout_cpt_4' , $nd_booking_meta_box_page_layout_cpt_4 ); }
