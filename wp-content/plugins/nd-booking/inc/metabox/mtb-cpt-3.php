...
function nd_booking_meta_box_save_cpt_3( $post_id )
{
    ...
    $nd_booking_meta_box_cpt_3_exceptions_type = sanitize_option( 'nd_booking_meta_box_cpt_3_exceptions_type', $_POST['nd_booking_meta_box_cpt_3_exceptions_type'] );
    if ( isset( $nd_booking_meta_box_cpt_3_exceptions_type ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_3_exceptions_type' , $nd_booking_meta_box_cpt_3_exceptions_type ); }

    $nd_booking_meta_box_cpt_3_price = sanitize_text_field( $_POST['nd_booking_meta_box_cpt_3_price'] );
    if ( isset( $nd_booking_meta_box_cpt_3_price ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_3_price' , $nd_booking_meta_box_cpt_3_price ); }

    $nd_booking_meta_box_cpt_3_date_range_from = sanitize_text_field( $_POST['nd_booking_meta_box_cpt_3_date_range_from'] );
    if ( isset( $nd_booking_meta_box_cpt_3_date_range_from ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_3_date_range_from' , $nd_booking_meta_box_cpt_3_date_range_from ); }

    $nd_booking_meta_box_cpt_3_date_range_to = sanitize_text_field( $_POST['nd_booking_meta_box_cpt_3_date_range_to'] );
    if ( isset( $nd_booking_meta_box_cpt_3_date_range_to ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_3_date_range_to' , $nd_booking_meta_box_cpt_3_date_range_to ); }
