...
function nd_booking_meta_box_save_cpt_2( $post_id )
{
    ...
    $nd_booking_meta_box_cpt_2_service_type = sanitize_option( 'nd_booking_meta_box_cpt_2_service_type', $_POST['nd_booking_meta_box_cpt_2_service_type'] );
    if ( isset( $nd_booking_meta_box_cpt_2_service_type ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_2_service_type' , $nd_booking_meta_box_cpt_2_service_type ); }

    $nd_booking_meta_box_cpt_2_icon = esc_url_raw( $_POST['nd_booking_meta_box_cpt_2_icon'] );
    if ( isset( $nd_booking_meta_box_cpt_2_icon ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_2_icon' , $nd_booking_meta_box_cpt_2_icon ); }

    $nd_booking_meta_box_cpt_2_color = sanitize_hex_color( $_POST['nd_booking_meta_box_cpt_2_color'] );
    if ( isset( $nd_booking_meta_box_cpt_2_color ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_2_color' , $nd_booking_meta_box_cpt_2_color ); }

    $nd_booking_meta_box_cpt_2_text_preview = sanitize_text_field( $_POST['nd_booking_meta_box_cpt_2_text_preview'] );
    if ( isset( $nd_booking_meta_box_cpt_2_text_preview ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_2_text_preview' , $nd_booking_meta_box_cpt_2_text_preview ); }
    ...
    if ( isset( $nd_booking_meta_box_cpt_2_price ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_2_price' , $nd_booking_meta_box_cpt_2_price ); }

    $nd_booking_meta_box_cpt_2_price_type_1 = sanitize_option( 'nd_booking_meta_box_cpt_2_price_type_1', $_POST['nd_booking_meta_box_cpt_2_price_type_1'] );
    if ( isset( $nd_booking_meta_box_cpt_2_price_type_1 ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_2_price_type_1' , $nd_booking_meta_box_cpt_2_price_type_1 ); }

    $nd_booking_meta_box_cpt_2_price_type_2 = sanitize_option( 'nd_booking_meta_box_cpt_2_price_type_2', $_POST['nd_booking_meta_box_cpt_2_price_type_2'] );
    if ( isset( $nd_booking_meta_box_cpt_2_price_type_2 ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_cpt_2_price_type_2' , $nd_booking_meta_box_cpt_2_price_type_2 ); }
