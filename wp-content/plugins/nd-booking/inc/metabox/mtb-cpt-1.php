...
function nd_booking_meta_box_save( $post_id )
{
    ...
    $nd_booking_meta_box_max_people = sanitize_text_field( $_POST['nd_booking_meta_box_max_people'] );
    if ( isset( $nd_booking_meta_box_max_people ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_max_people' , $nd_booking_meta_box_max_people ); }

    $nd_booking_meta_box_room_size = sanitize_text_field( $_POST['nd_booking_meta_box_room_size'] );
    if ( isset( $nd_booking_meta_box_room_size ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_room_size' , $nd_booking_meta_box_room_size ); }

    $nd_booking_meta_box_color = sanitize_hex_color( $_POST['nd_booking_meta_box_color'] );
    if ( isset( $nd_booking_meta_box_color ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_color' , $nd_booking_meta_box_color ); }

    $nd_booking_meta_box_text_preview = sanitize_text_field( $_POST['nd_booking_meta_box_text_preview'] );
    if ( isset( $nd_booking_meta_box_text_preview ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_text_preview' , $nd_booking_meta_box_text_preview ); }

    $nd_booking_meta_box_branches = sanitize_text_field( $_POST['nd_booking_meta_box_branches'] );
    if ( isset( $nd_booking_meta_box_branches ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_branches' , $nd_booking_meta_box_branches ); }

    $nd_booking_meta_box_qnt = sanitize_text_field( $_POST['nd_booking_meta_box_qnt'] );
    if ( isset( $nd_booking_meta_box_qnt ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_qnt' , $nd_booking_meta_box_qnt ); }

    $nd_booking_meta_box_min_booking_day = sanitize_text_field( $_POST['nd_booking_meta_box_min_booking_day'] );
    if ( isset( $nd_booking_meta_box_min_booking_day ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_min_booking_day' , $nd_booking_meta_box_min_booking_day ); }


    //price settings : sanitaze and validate
    $nd_booking_meta_box_price = sanitize_text_field( $_POST['nd_booking_meta_box_price'] );
    if ( isset( $nd_booking_meta_box_price ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_price' , $nd_booking_meta_box_price ); }

    $nd_booking_meta_box_week_price_mon = sanitize_text_field( $_POST['nd_booking_meta_box_week_price_mon'] );
    if ( isset( $nd_booking_meta_box_week_price_mon ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_week_price_mon' , $nd_booking_meta_box_week_price_mon ); }

    $nd_booking_meta_box_week_price_tue = sanitize_text_field( $_POST['nd_booking_meta_box_week_price_tue'] );
    if ( isset( $nd_booking_meta_box_week_price_tue ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_week_price_tue' , $nd_booking_meta_box_week_price_tue ); }

    $nd_booking_meta_box_week_price_wed = sanitize_text_field( $_POST['nd_booking_meta_box_week_price_wed'] );
    if ( isset( $nd_booking_meta_box_week_price_wed ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_week_price_wed' , $nd_booking_meta_box_week_price_wed ); }

    $nd_booking_meta_box_week_price_thu = sanitize_text_field( $_POST['nd_booking_meta_box_week_price_thu'] );
    if ( isset( $nd_booking_meta_box_week_price_thu ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_week_price_thu' , $nd_booking_meta_box_week_price_thu ); }

    $nd_booking_meta_box_week_price_fri = sanitize_text_field( $_POST['nd_booking_meta_box_week_price_fri'] );
    if ( isset( $nd_booking_meta_box_week_price_fri ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_week_price_fri' , $nd_booking_meta_box_week_price_fri ); }

    $nd_booking_meta_box_week_price_sat = sanitize_text_field( $_POST['nd_booking_meta_box_week_price_sat'] );
    if ( isset( $nd_booking_meta_box_week_price_sat ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_week_price_sat' , $nd_booking_meta_box_week_price_sat ); }

    $nd_booking_meta_box_week_price_sun = sanitize_text_field( $_POST['nd_booking_meta_box_week_price_sun'] );
    if ( isset( $nd_booking_meta_box_week_price_sun ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_week_price_sun' , $nd_booking_meta_box_week_price_sun ); }

    $nd_booking_meta_box_min_price = sanitize_text_field( $_POST['nd_booking_meta_box_min_price'] );
    if ( isset( $nd_booking_meta_box_min_price ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_min_price' , $nd_booking_meta_box_min_price ); }

    //services : sanitaze and validate
    $nd_booking_meta_box_normal_services = sanitize_text_field( $_POST['nd_booking_meta_box_normal_services'] );
    if ( isset( $nd_booking_meta_box_normal_services ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_normal_services' , $nd_booking_meta_box_normal_services ); }

    $nd_booking_meta_box_additional_services = sanitize_text_field( $_POST['nd_booking_meta_box_additional_services'] );
    if ( isset( $nd_booking_meta_box_additional_services ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_additional_services' , $nd_booking_meta_box_additional_services ); }

    //exceptions : sanitaze and validate
    $nd_booking_meta_box_exceptions = sanitize_text_field( $_POST['nd_booking_meta_box_exceptions'] );
    if ( isset( $nd_booking_meta_box_exceptions ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_exceptions' , $nd_booking_meta_box_exceptions ); }

    $nd_booking_meta_box_exceptions_block = sanitize_text_field( $_POST['nd_booking_meta_box_exceptions_block'] );
    if ( isset( $nd_booking_meta_box_exceptions_block ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_exceptions_block' , $nd_booking_meta_box_exceptions_block ); }

    //page settings : sanitaze and validate
    $nd_booking_meta_box_image = esc_url_raw( $_POST['nd_booking_meta_box_image'] );
    if ( isset( $nd_booking_meta_box_image ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_image' , $nd_booking_meta_box_image ); }
    ...
    if ( isset( $nd_booking_meta_box_image_position ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_image_position' , $nd_booking_meta_box_image_position ); }

    $nd_booking_meta_box_page_layout = sanitize_option( 'nd_booking_meta_box_page_layout', $_POST['nd_booking_meta_box_page_layout'] );
    if ( isset( $nd_booking_meta_box_page_layout ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_page_layout' , $nd_booking_meta_box_page_layout ); }

    $nd_booking_meta_box_featured_image_size = sanitize_text_field( $_POST['nd_booking_meta_box_featured_image_size'] );
    if ( isset( $nd_booking_meta_box_featured_image_size ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_featured_image_size' , $nd_booking_meta_box_featured_image_size ); }
    ...
    if ( isset( $nd_booking_meta_box_featured_image_replace ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_featured_image_replace' , $nd_booking_meta_box_featured_image_replace ); }


    //packages and similar rooms : sanitaze and validate
    $nd_booking_meta_box_title_packages = sanitize_text_field( $_POST['nd_booking_meta_box_title_packages'] );
    if ( isset( $nd_booking_meta_box_title_packages ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_title_packages' , $nd_booking_meta_box_title_packages ); }

    $nd_booking_meta_box_packages = sanitize_text_field( $_POST['nd_booking_meta_box_packages'] );
    if ( isset( $nd_booking_meta_box_packages ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_packages' , $nd_booking_meta_box_packages ); }

    $nd_booking_meta_box_packages_image_size = sanitize_text_field( $_POST['nd_booking_meta_box_packages_image_size'] );
    if ( isset( $nd_booking_meta_box_packages_image_size ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_packages_image_size' , $nd_booking_meta_box_packages_image_size ); }

    $nd_booking_meta_box_similar_rooms = sanitize_text_field( $_POST['nd_booking_meta_box_similar_rooms'] );
    if ( isset( $nd_booking_meta_box_similar_rooms ) ) { update_post_meta( $post_id, 'nd_booking_meta_box_similar_rooms' , $nd_booking_meta_box_similar_rooms ); }

    //ids : sanitaze and validate
    $nd_booking_post_id_room = sanitize_text_field( $_POST['nd_booking_post_id_room'] );
    if ( isset( $nd_booking_post_id_room ) ) { update_post_meta( $post_id, 'nd_booking_post_id_room' , $nd_booking_post_id_room ); }

    $nd_booking_id_room = sanitize_text_field( $_POST['nd_booking_id_room'] );
    if ( isset( $nd_booking_id_room ) ) { update_post_meta( $post_id, 'nd_booking_id_room' , $nd_booking_id_room ); }
